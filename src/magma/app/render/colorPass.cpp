                                    ...
                                    VkImageView shadow_map_view, VkSampler shadow_sampler)
{
    ...
    for (uint32_t i = 0; i < descriptorSetCount; ++i)
    {
        ...
        descriptorSetLayout.bindUniformBuffer(0, uniformBuffer.getBuffer(), 0, ubo_size);
        descriptorSetLayout.bindCombinedImageSampler(1, tex_view, sampler, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL);
        descriptorSetLayout.bindUniformBuffer(2, fragmentUniform.getBuffer(), 0, fu_size);
        descriptorSetLayout.bindUniformBuffer(3, lightSpaceUniform.getBuffer(), 0, lu_size);
