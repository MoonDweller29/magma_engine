...
HBAO::HBAO(vk::Device device, Texture ssaoTex, Queue queue) :
        ...
        )
{
    ...
    Shader fragShader("hbaoFrag", _device, "shaders/ssao/hbao.frag.spv", Shader::Stage::FRAG_SH);
...
vk::UniqueRenderPass HBAO::createRenderPass() {
...
vk::UniqueSampler HBAO::createImageSampler() {
